...
Heap		EQU 0x00004000
HeapSmall	EQU	0x00000C00
HeapMax		EQU	0x00008000
HeapMin		EQU	0x00000C00
...
;//     <o8.5>      PCPWM0: PWM 0 power/clock enable
...
;Undef_Handler  B       Undef_Handler          ; Sets error bit (see LabVIEW.c)
;SWI_Handler    B       SWI_Handler            ; Part of RTL
;PAbt_Handler   B       PAbt_Handler           ; Sets error bit (see LabVIEW.c)
;DAbt_Handler   B       DAbt_Handler           ; Part of RT-Agent
...
; Setup External Memory Controller ---------------------------------------------
              ...
              ;  LDR     R4, =EMC_PCONP_Const      ; Enable EMC, comment out as it turns off all other power
              ; STR     R4, [R1, #PCONP_OFS]		;  This is already enabled by PCONP_Val

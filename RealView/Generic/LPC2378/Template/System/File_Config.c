...
#ifdef Simulator
#error The simulator does not support the flash file system.
#endif
#ifdef __MICROLIB
#error The MicroLib does not support the flash file system.
#endif
 ...
 *---------------------------------------------------------------------------*/
 ...
 #if MC_RELOC == 1
  // used to avoid linking issues that come from the above 'mc_cache' symbol
  U32 dummy_cache[560];
 #endif
#else

//*****************************************************************************
//
// LM3Sxxxx_Timer1.c - Implements simple Timer initialization for use
...
//*****************************************************************************
void
LM3Sxxxx_Timer1Init(unsigned long ulCount, unsigned char ucUnits)
{
	//
    ...
    //
    TimerLoadSet(TIMER1_BASE, TIMER_A, ulCount);

//*****************************************************************************
//
// LM3Sxxxx_Timer2.c - Implements simple Timer initialization for use
...
//*****************************************************************************
void
LM3Sxxxx_Timer2Init(unsigned long ulCount, unsigned char ucUnits)
{
	//
    ...
    TimerControlStall(TIMER2_BASE, TIMER_A, 1);

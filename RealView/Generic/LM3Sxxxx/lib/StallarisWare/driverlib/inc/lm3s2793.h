...
#define HIB_RIS_LOWBAT          0x00000004  // Low Battery Voltage Raw
                                            // Interrupt Status.
#define HIB_RIS_RTCALT1         0x00000002  // RTC Alert 1 Raw Interrupt
                                            // Status.
#define HIB_RIS_RTCALT0         0x00000001  // RTC Alert 0 Raw Interrupt
                                            // Status.
...
#define SYSCTL_RCC2_OSCSRC2_419 0x00000060  // 4.19 MHz
...
#define SYSCTL_DSLPCLKCFG_O_419 0x00000060  // 4.194304 MHz

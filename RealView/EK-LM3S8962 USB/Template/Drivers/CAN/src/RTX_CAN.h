...
CAN_ERROR CAN_stop      (U32 ctrl);
CAN_ERROR CAN_close		(U32 ctrl);
CAN_ERROR CAN_send      (U32 ctrl, CAN_msg *msg, U16 timeout);
CAN_ERROR CAN_set_baudrate (U32 ctrl,U32 baudrate);
U32 CAN_get_baudrate (U32 ctrl);
U32 CAN_messageAvailable(U32 Ctrl);
